...
SongLyricsModel songLyricsModelFromJson(String str) =>
    SongLyricsModel.fromJson(json.decode(str));

String songLyricsModelToJson(SongLyricsModel data) =>
    json.encode(data.toJson());

class SongLyricsModel {
  Message? message;

  SongLyricsModel({this.message});

  SongLyricsModel.fromJson(Map<String, dynamic> json) {
    message =
